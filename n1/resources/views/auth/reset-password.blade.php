...
<head>
    <meta charset="utf-8" />
    <title>Group No1 - Multipurpose eCommerce Reset Password</title>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <form method="POST" action="{{ route('password.confirm') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="password" required="" name="password_confirmation" id="password_confirmation" placeholder="New Password Confirm" />
                                            </div>
                                            <div class="form-group">
